...
int main() {
    ...
    char const *mainlist= "Users/timocruz/Desktop/BSUIR/OAiP/rez/rez/main.txt"; // главный файл
    char const *deltelist= "Users/timocruz/Desktop/BSUIR/OAiP/rez/rez/delete.txt"; // список отчисленных
        ...
        switch(var){
            ...
            case 6:{ // удаление элементов
                ...
                if(gindex != -1){
                    ...
                    pop(students, amount, gindex); // удаление из основного файла
                    save(mainlist, students, amount);
                    load(mainlist);
                    puts("");
                    print(students, amount);
            ...
            case 7:{ // добавление в main.txt from delete.txt
                ...
                printf("Введите фамилию искомого человека: "); cin >> fa;
                printf("Введите фамилию искомого человека: "); cin >> ot;
                printf("Имя искомого человека: "); cin >> im;
                ...
                if(gindex != -1){
                    ...
                    pop(delstudents, delamount, gindex); // удаление из основного файла
                    save(deltelist, delstudents, delamount);
                    load(deltelist);
                    puts("");
                    print(students, amount);
